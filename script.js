// 1. Authentication and shared helpers
    ...
    products = [
      {
        ...
        price: 2500,
        description: "Secure and adjustable dashboard phone mount.",
        image: "https://via.placeholder.com/250x180?text=Car+Phone+Mount"
      },
      {
        name: "Interior LED Light Kit",
        price: 4500,
        description: "Bright LED lighting for your car interior.",
        image: "https://via.placeholder.com/250x180?text=LED+Light+Kit"
      },
      {
        name: "Premium Seat Covers",
        price: 6800,
        description: "Comfortable and stylish seat covers.",
        image: "https://via.placeholder.com/250x180?text=Seat+Covers"
      },
      {
        name: "Portable Car Vacuum",
        price: 5200,
        description: "Compact vacuum for quick car cleaning.",
        image: "https://via.placeholder.com/250x180?text=Car+Vacuum"
      },
      {
        name: "Luxury Air Freshener",
        price: 1200,
        description: "Keep your car smelling fresh.",
        image: "https://via.placeholder.com/250x180?text=Air+Freshener"
      },
      {
        name: "Dash Cam",
        price: 9500,
        description: "Record your drive with clear video footage.",
        image: "https://via.placeholder.com/250x180?text=Dash+Cam"
      }
    ];
...
function renderProducts() {
  ...
  products.forEach(product => {
    ...
    card.innerHTML = `
      <img src="${product.image}" alt="${product.name}" style="width:100%;max-width:250px;height:auto;">
      <h3>${product.name}</h3>
